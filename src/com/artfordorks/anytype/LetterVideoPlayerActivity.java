...
/**
 * Not really sure what this does but I think it controls the screen where a video captured 
 * with the letter is played
...
public class LetterVideoPlayerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.letterphoto);

		FrameLayout letter_frame = (FrameLayout) findViewById(R.id.letter_frame);
		
		mPhoto = (ImageView) findViewById(R.id.image_viewer);
